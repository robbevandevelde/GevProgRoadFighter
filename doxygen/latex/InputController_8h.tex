...
this file contains the movecontroller class that handles the access of current keyboard input over the whole roadfighter game it also contains 2 enums used to represent vertical and horizontal movement \begin{DoxyAuthor}{Author}
Thibaut Van Goethem 
\end{DoxyAuthor}
