...
\begin{center}
\leavevmode
\includegraphics[width=322pt]{EntityTransporter_8h__incl}
\end{center}
\end{figure}
...
this file is for the entity\+Transporter that will regulate the exchange of entities between the game and the world \begin{DoxyAuthor}{Author}
Thibaut Van Goethem 
\end{DoxyAuthor}
